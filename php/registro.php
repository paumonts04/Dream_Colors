...
if (isset($_POST['registrar'])) {
    ...
    if (!preg_match('/[A-Z]/', $pass)) {
        $errores[] = "La contrasena debe incluir una mayuscula.";
    }
    if (!preg_match('/[a-z]/', $pass)) {
        $errores[] = "La contrasena debe incluir una minuscula.";
    }
    if (!preg_match('/[0-9]/', $pass)) {
        $errores[] = "La contrasena debe incluir un numero.";
    }
    if (!preg_match('/[^A-Za-z0-9]/', $pass)) {
        $errores[] = "La contrasena debe incluir un caracter especial.";
    }
            ...
            <form action="registro.php" method="POST">
                ...
                <div class="form-group">
                    ...
                    <div class="input-password-container">
                        ...
                        <button type="button" class="password-toggle" data-toggle-password aria-label="Mostrar u ocultar contrasena">
                            <img src="../img/ojo_cerrado.png" alt="Mostrar contrasena" class="password-eye">
                        </button>
                    </div>
                </div>
